...
export const admins = pgTable("admins", {
  ...
  priority: integer("priority").notNull().default(0), // priority  0-blocked, 1-access only to change messages (can toggle is_checked) 2-access to 1-priority and change content and can delete messages 3-access to 1,2-proprities and add admins
  avatar: text("avatar"),
...
export const messages = pgTable("messages", {
  ...
  is_telegram: boolean("is_telegram").default(false).notNull(),
...
export const students = pgTable("students", {
  ...
  certificate_photo: text("certificate_photo").notNull(),
  ...
  review_uz: text("review_uz").notNull(),
  review_en: text("review_en").notNull(),
});
...
// Webs ----------------------------------------------------
export const webs = pgTable("webs", {
  id: serial("id").primaryKey(),
  ...
  footer_p_uz: text("footer_p_uz").notNull(),
  footer_p_en: text("footer_p_en").notNull(),
...
// WebMedia ------------------------------------------------
export const web_media = pgTable("web_media", {
  id: serial("id").primaryKey(),
...
// WebPhone ------------------------------------------------
export const web_phone = pgTable("web_phone", {
  id: serial("id").primaryKey(),
  web_id: integer("web_id")
    .notNull()
    .references(() => webs.id, { onDelete: "cascade" }),
...
// WebSocial ----------------------------------------------
export const web_social = pgTable("web_social", {
  id: serial("id").primaryKey(),
  web_id: integer("web_id")
    .notNull()
    .references(() => webs.id, { onDelete: "cascade" }),
...
// WebStudent ---------------------------------------------
export const web_student = pgTable("web_student", {
  id: serial("id").primaryKey(),
  order: integer("order").notNull(),
  web_id: integer("web_id")
    .notNull()
...
// WebTeacher ---------------------------------------------
export const web_teacher = pgTable("web_teacher", {
  id: serial("id").primaryKey(),
  order: integer("order").notNull(),
  web_id: integer("web_id")
    .notNull()
